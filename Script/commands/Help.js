...
`;
 ...
 const imgPath = __dirname + "/https://i.imgur.com/1NpxyTv.jpeg";
 const callback = () => api.sendMessage({ body: text, attachment: fs.createReadStream(imgPath) }, threadID, () => fs.unlinkSync(imgPath), messageID);
 return request("https://i.imgur.com/1NpxyTv.jpeg").pipe(fs.createWriteStream(imgPath)).on("close", () => callback());
 }
